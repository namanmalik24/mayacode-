...
const WorkflowHostPage: React.FC<WorkflowHostPageProps> = ({
    ...
    switch (workflowDetails.type) {
      case "formFilling":
        switch (currentStepConfig.id) {
          case "welcome":
            return <WelcomeStepPage {...stepProps} />;
          case "personalData":
            return <PersonalDataFormFillingPage {...stepProps} />;
          case "documents":
            return <DocumentsPage {...stepProps} />;
          case "transmitForm":
            return <TransmitFormPage {...stepProps} />;
          case "ama":
            return <AmaPage {...stepProps} />;
          case "complete":
            return <CompletePage {...stepProps} />;
          default:
            return <div>Unknown step for Form Filling</div>;
        }
      case "jobMatching":
        switch (currentStepConfig.id) {
          case "welcome":
            return <WelcomeStepPage {...stepProps} />;
          case "personalData":
            return <PersonalDataJobMatchingPage {...stepProps} />;
          case "jobMatching":
            return <JobMatchingPage {...stepProps} />;
          case "transmitApplication":
            return <TransmitApplicationPage {...stepProps} />;
          case "ama":
            return <AmaPage {...stepProps} />;
          case "complete":
            return <CompletePage {...stepProps} />;
          default:
            return <div>Unknown step for Job Matching</div>;
        }
      default:
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-text-primary">
      ...
      <footer className="p-4 border-t border-border-color bg-card sticky bottom-0">
        {" "}
        {/* Made footer sticky */}
        <div className="container mx-auto flex justify-between items-center">
          ...
          <ActionButton
            ...
            variant="primary"
            icon={
              !isLastStep ? <ChevronRightIcon className="w-5 h-5" /> : undefined
            }
          >

...
import { getTaskIcon } from '../icons/icons'; 
  ...
  return (
    ...
    >
      ...
      <div className="w-full">
        ...
        <span className={`text-xs font-medium px-2 py-1 rounded-full ${statusClasses.badgeBg} ${statusClasses.badgeText} block text-center`}>
          {statusText}
        </span>
      </div>
    </button>

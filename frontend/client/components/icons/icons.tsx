...
export const ClipboardDocumentListIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.172a2.25 2.25 0 0 0-1.724 0A2.25 2.25 0 0 1 12.75 4.5V6A2.25 2.25 0 0 0 15 8.25h5.25M7.5 15h3M7.5 18h3M7.5 12h3m-4.5 9H5.25A2.25 2.25 0 0 1 3 18.75V5.25A2.25 2.25 0 0 1 5.25 3h4.5M15 8.25H7.5" />
  </svg>
);
